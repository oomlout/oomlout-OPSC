...
module oi(item,x=0,y=0,z=0,ex=0,length=0,rotX=0,rotY=0,rotZ=0,width=0,height=0,depth=0,rad=0){
    OPSCInsert(item,x,y,z,ex,length,rotX,rotY,rotZ,width,height,depth,rad);
}

module OPSCInsert(item,x=0,y=0,z=0,ex=0,length=0,rotX=0,rotY=0,rotZ=0,width=0,height=0,depth=0,rad=0){
    translate([x,y,z]){
            rotate([rotX,rotY,rotZ]){
                ...
                if(item=="M3NutClearanceSlide"){ //add an extra half mm
                    OPSCInsertItemMM("M3NutClearance",0,0,ooZ=0,height=5);   
                    OPSCInsertItemMM("M3NutClearance",0.5,0,ooZ=0,height=5);   
                    OPSCInsertItemMM("M3NutClearance",-0.5,0,ooZ=0,height=5);   
         
                }
                if(item=="M3NutCaptiveSideInsert"){ 
                   OOBBPolygon3DComplete(6,0,0,OOBBNutM3Width/2,height,0);
                    OPSCInsertItemMM("M3NutCaptive",0,0,ooZ=0,height=height);   
                    translate([0,0,-height]){
                        linear_extrude(height){
                            translate([0,10,0]){
                ...
                if(item=="Bearing6806"){
                        OPSCHole(OOBBBearing6806Outside,7,0);
                        OPSCHole(OOBBBearing6806Little,100,50);
                }
                if(item=="Bearing6808"){
                        OPSCHole(OOBBBearing6808Outside,7,0);
                        OPSCHole(OOBBBearing6808Little,100,50);
                }
                if(item=="Bearing6810"){
                ...
                if(item=="Bearing6806Hold"){
                        OPSCHole(OOBBBearing6806OutsideHold,7,0);
                        OPSCHole(OOBBBearing6806Little,100,50);
                }
                if(item=="Bearing6808Hold"){
                        OPSCHole(OOBBBearing6808OutsideHold,7,0);
                        OPSCHole(OOBBBearing6808Little,100,50);
                }
                if(item=="Bearing6810Hold"){
                        OPSCHole(OOBBBearing6810OutsideHold,7,0);
                    echo("6810 Hold Radius");
                    echo(OOBBBearing6810OutsideHold * 2);
                        OPSCHole(OOBBBearing6810Little,100,50);
                }
                if(item=="Bearing6704"){
                        OPSCHole(OOBBBearing6704Outside,4,0);
                        OPSCHole(OOBBBearing6704Little,100,50);
                }
                if(item=="Bearing6704Hold"){
                        OPSCHole(OOBBBearing6704OutsideHold,4,0);
                        OPSCHole(OOBBBearing6704Little,100,50);
                }
                ...
                if(item=="Bearing6803Hold"){
                        OPSCHole(OOBBBearing6803OutsideHold,5,0);
                        OPSCHole(OOBBBearing6803Little,100,50);
                }
                ...
                if(item=="BearingJoiner0303"){
                    OPSCInsertItemCoord("M3Hole",1.5,1);
                    OPSCInsertItemCoord("M3CountersinkUpsideDown",1.5,1);
                    OPSCInsertItemCoord("M3Hole",2.5,3);
                    OPSCInsertItemCoord("M3CountersinkUpsideDown",2.5,3);
                    
                    OPSCInsertItemCoord("M3Hole",1,2.5);           
                    OPSCInsertItemCoord("M3NutCaptive",1,2.5,2.4,2.4);
                    OPSCInsertItemCoord("M3Hole",3,1.5);
                    OPSCInsertItemCoord("M3NutCaptive",3,1.5,2.4,2.4);
                }
                
                
                if(item=="NEMA17"){
                    OPSCInsertItemMM("M3Hole",31/2,31/2);
                    OPSCInsertItemMM("M3SocketHead",31/2,31/2,ooZ=0);
                    OPSCInsertItemMM("M3Hole",-31/2,31/2);
                    OPSCInsertItemMM("M3SocketHead",-31/2,31/2,ooZ=0);
                    OPSCInsertItemMM("M3Hole",31/2,-31/2);
                    OPSCInsertItemMM("M3SocketHead",31/2,-31/2,ooZ=0);
                ...
                if(item=="B1X"){
                    translate([0,0,-20.5]){
                        ...
                        OPSCInsertItemMM("M3Hole",xx1,yy1);
                        OPSCInsertItemMM("M3SocketHead",xx1,yy1,height=shH);
                        OPSCInsertItemMM("M3Hole",xx1,yy2);
                        OPSCInsertItemMM("M3SocketHead",xx1,yy2,height=shH);
                        OPSCInsertItemMM("M3Hole",xx2,yy1);
                        OPSCInsertItemMM("M3SocketHead",xx2,yy1,height=shH);
                        OPSCInsertItemMM("M3Hole",xx2,yy2);
                        OPSCInsertItemMM("M3SocketHead",xx2,yy2,height=shH);
                      ...
                      //captive nuts
                        OPSCInsertItemMM("M3NutCaptiveSingle",xx1,yy1,ooZ=-6.5+OOBBNutM3Height);
            OPSCInsertItemMM("M3NutCaptiveSingle",xx1,yy2,ooZ=-6.5+OOBBNutM3Height);
            OPSCInsertItemMM("M3NutCaptiveSingle",xx2,yy1,ooZ=-6.5+OOBBNutM3Height);
            OPSCInsertItemMM("M3NutCaptiveSingle",xx2,yy2,ooZ=-6.5+OOBBNutM3Height);
                ...
                if(item=="ServoFullMount"){
                   //OOBBCube3DComplete(x,y,wid,hei,height,z)
                    ...
                    translate([0,0,-10]){
                        ...
                        h2= 4 + 2.5;
                        //translate([0,0,10+h2]){
                        //    OPSCInsertItemMM("M45Sock",x1,y1,height=h2);
                        //    OPSCInsertItemMM("M45Sock",x1,y2,height=h2);
                        //    OPSCInsertItemMM("M45Sock",x2,y1,height=h2);
                        //    OPSCInsertItemMM("M45Sock",x2,y2,height=h2);
                        //}
                    }
                    }
                
                    
                    OPSCInsertItemMM("M3Hole",x1,y1);
                    OPSCInsertItemMM("M3SocketHead",x1,y1,height=6.5+OOBBm3SocketHeadDepth);
                    OPSCInsertItemMM("M3NutCaptiveSingle",x1,y1,OOBBNutM3Height);
                    OPSCInsertItemMM("M3Hole",x1,y2);
                    OPSCInsertItemMM("M3SocketHead",x1,y2,height=6.5+OOBBm3SocketHeadDepth);
                    OPSCInsertItemMM("M3NutCaptiveSingle",x1,y2,OOBBNutM3Height);
                    OPSCInsertItemMM("M3Hole",x2,y1);
                    OPSCInsertItemMM("M3SocketHead",x2,y1,height=6.5+OOBBm3SocketHeadDepth);
                    OPSCInsertItemMM("M3NutCaptiveSingle",x2,y1,OOBBNutM3Height);
                    OPSCInsertItemMM("M3Hole",x2,y2);
                    OPSCInsertItemMM("M3SocketHead",x2,y2,height=6.5+OOBBm3SocketHeadDepth);
                    OPSCInsertItemMM("M3NutCaptiveSingle",x2,y2,OOBBNutM3Height);
                    ...
                    screwLength=12;
                    OPSCInsert("M3SocketHeadFullNut",x1,y1,height=6.5+OOBBm3SocketHeadDepth,length=screwLength);
                    OPSCInsert("M3SocketHeadFullNut",x2,y1,height=6.5+OOBBm3SocketHeadDepth,length=screwLength);
                    OPSCInsert("M3SocketHeadFullNut",x1,y2,height=6.5+OOBBm3SocketHeadDepth,length=screwLength);
                    OPSCInsert("M3SocketHeadFullNut",x2,y2,height=6.5+OOBBm3SocketHeadDepth,length=screwLength);
                }
              if(item=="M45Sock"){
              ...
              if(item=="PiCameraMount"){
                  OPSCInsertItemMM("M2RivetUpsideDown",-10.5,10,0);
                  OPSCInsertItemMM("M2RivetUpsideDown",-10.5,-2.5,0);
                  OPSCInsertItemMM("M2RivetUpsideDown",10.5,10,0);
                  OPSCInsertItemMM("M2RivetUpsideDown",10.5,-2.5,0);
                  translate([0,2,-10]){
                      linear_extrude(20){
              ...
              if(item=="PiZeroMount"){
                  OPSCInsertItemMM("M27Rivet",-29,11.5,0);
                  OPSCInsertItemMM("M27Rivet",-29,-11.5,0);
                  OPSCInsertItemMM("M27Rivet",29,11.5,0);
                  OPSCInsertItemMM("M27Rivet",29,-11.5,0);
                  translate([0,-11.5,3]){
              ...
              if(item=="PiZeroMountUpsideDown"){
                  OPSCInsertItemMM("M27RivetUpsideDown",-29,11.5,0);
                  OPSCInsertItemMM("M27RivetUpsideDown",-29,-11.5,0);
                  OPSCInsertItemMM("M27RivetUpsideDown",29,11.5,0);
                  OPSCInsertItemMM("M27RivetUpsideDown",29,-11.5,0);
                  translate([0,-11.5,0]){
...
module OOEBNormalCableInsertUpsideDown(ex){
          OPSCInsertItemMM("OOEBNormalUpsideDown",0,0,0,ex=0);
          translate([0,0,0]){
          //top
            translate([0,0,0]){  
                linear_extrude(6){
